...
class ArgParse(object):
    ...
    def _parse_arguments(self, argv):
        ...
        parser.add_argument('-t', '--title', metavar='title', help='title  plotting.')
        ...
        parser.add_argument('-v', '--printvar', metavar='printvar', action='append', help='print data value on screen.')
        ...
        parser.add_argument('--num-xinputs', metavar='number of xinputs', type=int, default=num_xinputs, help='number of x inputs.')
        parser.add_argument('--num-yinputs', metavar='number of yinputs', type=int, default=num_yinputs, help='number of y inputs.')
        parser.add_argument('--num-zinputs', metavar='number of zinputs', type=int, default=num_zinputs, help='number of z inputs.')
        ...
        parser.add_argument('--template', metavar='template', action='append', help='plot template')
