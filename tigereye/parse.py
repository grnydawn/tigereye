...
class ArgParse(object):
    ...
    def _parse_arguments(self, argv):
        ...
        parser.add_argument('-g', metavar='g', nargs='?', const='b=True', help='grid for ax plotting.')
        parser.add_argument('-l', metavar='l', nargs='?', const='plots, plot_labels, loc="best"', help='legend for ax plotting')
        ...
        parser.add_argument('--xaxis', metavar='xaxis', action='append', default=[], help='axes function wrapper for x axis settings.')
        parser.add_argument('--yaxis', metavar='yaxis', action='append', default=[], help='axes function wrapper for y axis settings.')
        parser.add_argument('--zaxis', metavar='zaxis', action='append', default=[], help='axes function wrapper for z axis settings.')
